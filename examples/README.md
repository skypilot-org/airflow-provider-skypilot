...
- [NYC Taxi Data Processing](nyc_taxi_data/README.md)
- [Machine Learning Training](ml_training/README.md)
- [Hello World](hello_world/README.md)
- [Hello World (Local YAML)](hello_world_local/README.md)
- [AWS Credentials Integration](aws_credentials/README.md)
- [GCP Credentials Integration](gcp_credentials/README.md)
- [Git Repo Workdir Integration](git_workdir/README.md)
...
4. Some examples may require additional prerequisites, as documented in the respective READMEs
